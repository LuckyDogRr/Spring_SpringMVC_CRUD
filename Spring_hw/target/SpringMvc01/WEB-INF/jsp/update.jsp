            ...
            <div>
                <form action="${pageContext.request.contextPath}/StudentServlet?method=updateStudent" method="post">
                    ...
                    <div class="form-group field-contacts-name required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-name" class="form-control" name="sname" value="${UpStu.sname}"
                                   maxlength="20"
                                   placeholder="姓名">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="stuAge" name="age" maxlength="20" placeholder="年龄" value="${UpStu.age}">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div>
                                ...
                                <label class="label-radio inline">
                                    <input type="radio" name="gender" value="男" checked> <span
                                        class="custom-radio"></span>男</label>
                                <label class="label-radio inline">
                                    <input type="radio" name="gender" value="女"><span
                    ...
                    <div>
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="StuAddress" name="address" maxlength="20" placeholder="地址" value="${UpStu.address}">
                        </div>
                    </div>
