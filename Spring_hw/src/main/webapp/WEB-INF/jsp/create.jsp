...
<div>
    <form action="${pageContext.request.contextPath}/StudentServlet?method=addStudent" method="post">
        <div>
            ...
            <div class="col-sm-8">
                <div>
                    <label class="label-radio inline">
                        <input type="radio" name="gender" value="男" > <span class="custom-radio"></span>男</label>
                    <label class="label-radio inline">
